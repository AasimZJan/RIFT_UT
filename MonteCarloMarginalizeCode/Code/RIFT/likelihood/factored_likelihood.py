...
try:
        import RIFT.physics.EFPE as EFPE
        has_EFPE=True
except:
        has_EFPE=False
...
#                print " FFT for conjugate mode ", mode, bT[mode].data.length
    ...
    elif use_EFPE and (has_EFPE):
        if not quiet:
            print( "  FACTORED LIKELIHOOD WITH hlmoff (EFPE) " )
        hlms, hlms_conj = EFPE.std_and_conj_hlmoff(P, Lmax,**extra_waveform_kwargs)
...
def PrecomputeLikelihoodTerms(event_time_geo, t_window, P, data_dict,
        ...
        internal_fast_precompute=True,
         NR_group=None,NR_param=None,
        ignore_threshold=None,   # dangerous for peak lnL of 25^2/2~300 : biases
        extra_waveform_kwargs={},
        use_gwsignal=False,
        use_gwsignal_approx=None,
        use_EFPE=False,
    ...
    hlms, hlms_conj = internal_hlm_generator(P,Lmax, verbose=verbose, quiet=quiet,
                                             ...
                                             skip_interpolation=skip_interpolation,use_EFPE=use_EFPE)
