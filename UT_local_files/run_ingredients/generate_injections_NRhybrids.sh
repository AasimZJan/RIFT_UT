#!/bin/bash
# write mdc.xml.gz
util_WriteInjectionFile.py --parameter m1 --parameter-value 93.75 --parameter m2 --parameter-value 6.25 --parameter s1x --parameter-value 0.0 --parameter s1y --parameter-value 0.0 --parameter s1z --parameter-value 0.0 --parameter s2x --parameter-value 0.0 --parameter s2y --parameter-value 0.0 --parameter s2z --parameter-value 0.0 --parameter eccentricity --parameter-value 0 --approx SEOBNRv4 --parameter dist --parameter-value 530.6990386393425 --parameter fmin --parameter-value 15 --parameter incl --parameter-value 0.7 --parameter tref --parameter-value 1000000000 --parameter phiref --parameter-value 0.0 --parameter theta --parameter-value 0.1 --parameter phi --parameter-value 0.57 --parameter psi --parameter-value 0.0

# generate injections, will create plots with verbose flag
util_LALNRWriteFrame.py --inj mdc.xml.gz --event 0 --instrument H1 --start 999999850 --stop 1000000150 --l-max 2 --srate 8192 --seglen 4 --verbose --path-to-hdf5 '../SXS_BBH_2477_NR.h5'
util_LALNRWriteFrame.py --inj mdc.xml.gz --event 0 --instrument L1 --start 999999850 --stop 1000000150 --l-max 2 --srate 8192 --seglen 4 --verbose --path-to-hdf5 '../SXS_BBH_2477_NR.h5'
util_LALNRWriteFrame.py --inj mdc.xml.gz --event 0 --instrument V1 --start 999999850 --stop 1000000150 --l-max 2 --srate 8192 --seglen 4 --verbose --path-to-hdf5 '../SXS_BBH_2477_NR.h5'
